 ...
 * Ollivanders2 Books
 *
 * These books will work with the new implementation of bookLearning. Every
 * Ollivanders2 spell must be in an O2Book (or some other book with lore set up
 * correctly) or players will not be able to learn them when bookLearning is
 * enabled.
 *
 * @since 2.2.4
 * @author Azami7
...
public final class O2Books {
	...
	/**
	 * If bookLearning is enabled, read the lore for a book and learn all spells
	 * not yet known.
	 *
	 * @param bookLore
	 *            the lore from a book
	 * @param player
