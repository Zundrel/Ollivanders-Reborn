...
public abstract class Book {
	...
	/**
	 * No more than 11 spells in a book or they won't fit on the table of
	 * contents.
	 */
	 ...
	 *
	 * @param bookItem
	 *            the book item to write metadata on.
	 */
	 ...
	 *
	 * Book pages cannot be more than 14 lines with ~18 characters per line, 256
	 * characters max assume 2 lines for spell name, 1 blank line between name
	 * and flavor text, 1 blank link between flavor text and description text,
	 * means the first page has 9 lines of ~15 characters + continue, subsequent
	 * pages are 13 lines of ~15 characters + continue.
	 *
	 * This means the first page for a spell can have ~175 characters and
	 * subsequent pages can be ~195.
	 *
	...
	/**
	 * Create the lore for this book. This will contain the name of each spell
	 * and is used by bookLearning to know what spells are in this book.
	 *
	...
	public ItemStack createBook(Ollivanders2 plugin) {
		...
		if (bookMeta == null) {
			...
			if (branch == O2MagicBranch.CHARMS || branch == O2MagicBranch.DARK_ARTS || branch == O2MagicBranch.TRANSFIGURATION || branch == O2MagicBranch.ARITHMANCY || branch == O2MagicBranch.HEALING) {
