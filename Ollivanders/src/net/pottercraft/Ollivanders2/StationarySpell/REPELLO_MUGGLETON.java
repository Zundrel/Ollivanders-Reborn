...
/**
 * Hides all blocks within its area by sending out block changes. Hides all
 * players within its area. The code to hide players is located in
 * OllivandersSchedule.invisPlayer()
 *
 * @author lownes
 */
public class REPELLO_MUGGLETON extends StationarySpellObj implements StationarySpell {
	private static final long serialVersionUID = 1577710734867708019L;
