...
public final class REPELLO_MUGGLETON extends Charms {
	...
	public void checkEffect() {
		...
		if (getBlock().getType() != Material.AIR && getBlock().getType() != Material.FIRE && getBlock().getType() != Material.WATER && getBlock().getType() != Material.STATIONARY_WATER) {
			...
			net.pottercraft.Ollivanders2.StationarySpell.REPELLO_MUGGLETON stat = new net.pottercraft.Ollivanders2.StationarySpell.REPELLO_MUGGLETON(player, location, StationarySpells.REPELLO_MUGGLETON, 5, duration);
			stat.flair(10);
