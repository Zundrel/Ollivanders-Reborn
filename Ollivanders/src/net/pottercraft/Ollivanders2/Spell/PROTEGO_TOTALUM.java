...
public final class PROTEGO_TOTALUM extends Charms {
	...
	public void checkEffect() {
		...
		if (getBlock().getType() != Material.AIR && getBlock().getType() != Material.FIRE && getBlock().getType() != Material.WATER && getBlock().getType() != Material.STATIONARY_WATER) {
			...
			net.pottercraft.Ollivanders2.StationarySpell.PROTEGO_TOTALUM total = new net.pottercraft.Ollivanders2.StationarySpell.PROTEGO_TOTALUM(player, location, StationarySpells.PROTEGO_TOTALUM, 5, duration);
			total.flair(10);
