...
public class Ollivanders2WorldGuard {
	...
	/**
	 * If WorldGuard is enabled, determine if this player has permissions to
	 * damage friendly mobs in this location. This is done so that Ollivanders2
	 * actions do not complete partially, such as mob transfiguration spells,
	 * and then cannot complete because WorldGuard is enabled.
	 *
	 * @param player
	 * @param location
	 * @return true if the player is allowed to damage friendly mobs in this
	...
	/**
	 * If WorldGuard is enabled, determine if PVP is allowed in this location.
	 * This is done so that Ollivanders2 actions do not complete partially, such
	 * as mob transfiguration spells, and then cannot complete because
	 * WorldGuard is enabled.
	 *
	 * @param player
	 * @param location
	 * @return true if the player can damage friendly mobs at this location,
	 *         false otherwise
	 */
	...
	/**
	 * If WorldGuard is enabled, determine if mobs can be spawned at a location.
	 * This is done so that Ollivanders2 actions do not complete partially, such
	 * as mob transfiguration spells, and then cannot complete because
	 * WorldGuard is enabled.
	 *
	 ...
	 * This is done so that Ollivanders2 actions do not complete partially, such
	 * as object transformation spells, and then cannot complete because
	 * WorldGuard is enabled.
	 *
	 ...
	 * @param player
	 * @param location
	 * @return true if the player has permissions to build at their location,
	 *         false otherwise
	 */
